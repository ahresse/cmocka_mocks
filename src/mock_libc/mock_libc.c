...
void *MOCK_FUNC_WRAP(memcpy)(void *destination, const void *source,
                             size_t num) {
...
int MOCK_FUNC_WRAP(connect)(int fd, const struct sockaddr *addr,
                            socklen_t len) {
...
int MOCK_FUNC_WRAP(pselect)(int nfds, fd_set *readfds, fd_set *writefds,
  ...
  return MOCK_FUNC_REAL(pselect)(nfds, readfds, writefds, exceptfds, timeout,
                                 sigmask);
}
...
int MOCK_FUNC_WRAP(pthread_create)(pthread_t *__newthread,
  ...
  return MOCK_FUNC_REAL(pthread_create)(__newthread, __attr, __start_routine,
                                        __arg);
}
...
int MOCK_FUNC_WRAP(pthread_mutex_init)(pthread_mutex_t *__mutex,
...
int MOCK_FUNC_WRAP(pthread_mutex_timedlock)(pthread_mutex_t *__mutex,
...
int MOCK_FUNC_WRAP(sem_init)(sem_t *__sem, int __pshared,
...
int MOCK_FUNC_WRAP(sem_timedwait)(sem_t *__sem,
                                  const struct timespec *__abstime) {
