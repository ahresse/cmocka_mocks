...
MOCK_FUNC_PROTOTYPE(mnl_socket_bind, int, struct mnl_socket *nl,
                    unsigned int groups, pid_t pid)
MOCK_FUNC_PROTOTYPE(mnl_socket_close, int, struct mnl_socket *nl)
MOCK_FUNC_PROTOTYPE(mnl_socket_recvfrom, ssize_t, const struct mnl_socket *nl,
                    void *buf, size_t siz)
MOCK_FUNC_PROTOTYPE(mnl_socket_sendto, ssize_t, const struct mnl_socket *nl,
