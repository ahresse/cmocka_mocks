...
const char *
MOCK_FUNC_WRAP(json_object_to_json_string)(struct json_object *obj) {
...
const char *
MOCK_FUNC_WRAP(json_object_to_json_string_length)(struct json_object *obj,
...
void MOCK_FUNC_WRAP(json_object_set_serializer)(
  ...
  MOCK_FUNC_REAL(json_object_set_serializer)
  (jso, to_string_func, userdata, user_delete);
}
...
json_bool
MOCK_FUNC_WRAP(json_object_object_get_ex)(const struct json_object *obj,
                                          const char *key,
...
struct json_object *
MOCK_FUNC_WRAP(json_object_new_array_ext)(int initial_size) {
...
int MOCK_FUNC_WRAP(json_object_set_int)(struct json_object *obj,
                                        int new_value) {
...
int MOCK_FUNC_WRAP(json_c_set_serialization_double_format)(
  ...
  return MOCK_FUNC_REAL(json_c_set_serialization_double_format)(
      double_format, global_or_thread);
}
...
int MOCK_FUNC_WRAP(json_object_double_to_json_string)(struct json_object *jso,
  ...
  return MOCK_FUNC_REAL(json_object_double_to_json_string)(jso, pb, level,
                                                           flags);
}
...
int MOCK_FUNC_WRAP(json_object_deep_copy)(
    struct json_object *src, struct json_object **dst,
...
struct json_object *
MOCK_FUNC_WRAP(json_object_from_file)(const char *filename) {
