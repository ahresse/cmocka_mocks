...
EVP_PKEY *MOCK_FUNC_WRAP(PEM_read_PUBKEY)(FILE *fp, EVP_PKEY **x,
                                          pem_password_cb *cb, void *u);
EVP_PKEY *MOCK_FUNC_REAL(PEM_read_PUBKEY)(FILE *fp, EVP_PKEY **x,
                                          pem_password_cb *cb, void *u);

MOCK_FUNC_VAR_EXTERN(EVP_DecodeBlock);
int MOCK_FUNC_WRAP(EVP_DecodeBlock)(unsigned char *t, const unsigned char *f,
                                    int n);
int MOCK_FUNC_REAL(EVP_DecodeBlock)(unsigned char *t, const unsigned char *f,
                                    int n);
...
int MOCK_FUNC_WRAP(EVP_DigestVerifyInit)(EVP_MD_CTX *ctx, EVP_PKEY_CTX **pctx,
                                         const EVP_MD *type, ENGINE *e,
                                         EVP_PKEY *pkey);
int MOCK_FUNC_REAL(EVP_DigestVerifyInit)(EVP_MD_CTX *ctx, EVP_PKEY_CTX **pctx,
                                         const EVP_MD *type, ENGINE *e,
                                         EVP_PKEY *pkey);

MOCK_FUNC_VAR_EXTERN(EVP_DigestUpdate);
int MOCK_FUNC_WRAP(EVP_DigestUpdate)(EVP_MD_CTX *ctx, const void *d,
                                     size_t cnt);
int MOCK_FUNC_REAL(EVP_DigestUpdate)(EVP_MD_CTX *ctx, const void *d,
                                     size_t cnt);

MOCK_FUNC_VAR_EXTERN(EVP_DigestVerifyFinal);
int MOCK_FUNC_WRAP(EVP_DigestVerifyFinal)(EVP_MD_CTX *ctx,
                                          const unsigned char *sig,
                                          size_t siglen);
int MOCK_FUNC_REAL(EVP_DigestVerifyFinal)(EVP_MD_CTX *ctx,
                                          const unsigned char *sig,
                                          size_t siglen);
